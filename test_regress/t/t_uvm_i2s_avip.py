#!/usr/bin/env python3
# DESCRIPTION: Verilator: Test I2S AVIP from mbits-mirafra
#
# Tests I2S verification IP using UVM BFM pattern
...
avip_dir = os.path.expanduser('~/repos/mbits-mirafra/i2s_avip')

# Wrapper module that instantiates hdlTop and hvlTop
test.top_filename = "t/t_uvm_i2s_avip.v"
