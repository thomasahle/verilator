#!/usr/bin/env python3
# DESCRIPTION: Verilator: Test SPI AVIP from mbits-mirafra
#
# Tests SPI verification IP using UVM BFM pattern
...
avip_dir = os.path.expanduser('~/repos/mbits-mirafra/spi_avip')

# Use a dummy top file - the real top is in verilator.f
test.top_filename = "t/t_uvm_spi_avip.v"
