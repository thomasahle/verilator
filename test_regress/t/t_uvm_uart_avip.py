#!/usr/bin/env python3
# DESCRIPTION: Verilator: Test UART AVIP from mbits-mirafra
#
# Tests UART verification IP using UVM BFM pattern
...
avip_dir = os.path.expanduser('~/repos/mbits-mirafra/uart_avip')

# Use a dummy top file - the real top is in verilator.f
test.top_filename = "t/t_uvm_uart_avip.v"
