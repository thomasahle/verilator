#!/usr/bin/env python3
# DESCRIPTION: Verilator: Test I3C AVIP from mbits-mirafra
#
# Tests I3C verification IP using UVM BFM pattern
...
avip_dir = os.path.expanduser('~/repos/mbits-mirafra/i3c_avip')

# Use a dummy top file - the real top is in verilator.f
test.top_filename = "t/t_uvm_i3c_avip.v"
